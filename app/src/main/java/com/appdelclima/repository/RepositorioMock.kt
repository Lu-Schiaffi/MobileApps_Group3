...
import com.appdelclima.repository.modelos.CurrentDto
import com.appdelclima.repository.modelos.ForecastDto
import com.appdelclima.repository.modelos.ForecastItemDto
import com.appdelclima.repository.modelos.GeoCityDto
import com.appdelclima.repository.modelos.MainDto
import com.appdelclima.repository.modelos.MainForecastDto
import com.appdelclima.repository.modelos.WeatherDescDto
    ...
    override suspend fun pronostico5(lat: Double, lon: Double): ForecastDto =
        ForecastDto(
            list = listOf(
                ForecastItemDto(
                    "2025-11-15 12:00:00",
                    MainForecastDto(18.0, 23.0, 55),
                    listOf(WeatherDescDto("Clouds", "nublado"))
                )
            )
        )
}